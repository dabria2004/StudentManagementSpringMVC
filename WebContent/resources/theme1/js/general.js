...
function menu(){
    ...
    html = html +'<ul>'
    html = html +'<li><a href="/StudentManagementSpring/setupaddclass">Class Registration</a></li>';
    html = html +'<li><a href="/StudentManagementSpring/setupsearchstudent">Student Search</a></li>';
    html = html +'<li><a href="/StudentManagementSpring/setupaddstudents">Student Registration</a></li>';
    html = html +'</ul>';
    html = html +'</li>';
    html = html +'<li id="no-child">';
    html = html +'<a href="/StudentManagementSpring/setupusersearch" style="font-weight:bold;">User Management</a>';
    html = html +'</li>';
    html = html +'</ul>';
    html = html +'</div>';
